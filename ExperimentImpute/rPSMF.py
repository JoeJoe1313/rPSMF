...
def main():
    ...
    for i in _range(args.repeats):
        ...
        for r in ranks:
            ...
            [ep, ef, rt, ib, res] = robust_PSMF(
                Y, C, X, d, T, r, M, missMask, V, Q, R, P, lambda0, sig, Iter, YorigInt, Einit,
            )
            # fmt: oon
    ...
    for r in ranks:
        ...
        fo = f"ExperimentImpute/output/beijing_temperature_{args.percentage}_rPSMF_{r}.json"
        ...
        plt.savefig(f"rpsmf_input_{args.percentage}_{r}.pdf")
